...
- **Telemetry:** emitted sense/diagnose/heal/scout events for `run-20260708T0603`; `send`/`publish` attempted at REPORT (see channel-status line — Telegram push expected to fail per the same egress block).
