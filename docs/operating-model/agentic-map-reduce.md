...
> matters as much as WHETHER you map. Re-measured 2026-07-05 with clean "reply OK" probes
> (`docs/research/token-economy-comparison-2026-07-05.md`): floor = **35,753 tok/general-purpose
> lane vs 16,960/Explore lane** → the narrow-grant rule alone saves **−18.8K (−52.6%) per
> read-only lane** before any work happens. Budget ~15% retry overhead: ~1/7 lanes corrupts at
> dispatch (garbage return, ≈ one floor wasted); relaunch fresh, don't continue the corrupted lane.
