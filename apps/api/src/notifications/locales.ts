...
const sq: LocaleMessages = {
  ...
  'order.dispatch_failed': (v) => `🚨 <b>#${v.shortOrderId || '???'} — Nuk u gjet korrier</b>\n\nDërgesa dështoi pas të gjitha përpjekjeve. Caktoni një korrier manualisht ose anuloni porosinë.`,
...
const en: LocaleMessages = {
  ...
  'order.dispatch_failed': (v) => `🚨 <b>#${v.shortOrderId || '???'} — No courier found</b>\n\nDispatch exhausted after all attempts. Assign a courier manually or cancel the order.`,
...
const uk: LocaleMessages = {
  ...
  'order.dispatch_failed': (v) => `🚨 <b>#${v.shortOrderId || '???'} — Кур'єра не знайдено</b>\n\nДоставку не вдалося призначити після всіх спроб. Призначте кур'єра вручну або скасуйте замовлення.`,
