...
export default (async function brandingPreviewRoutes(fastify, opts) {
  ...
  server.get('/branding-preview/:slug', async (request, reply) => {
    const csp = `default-src 'self'; img-src 'self' data: https://cdn.dowiz.org; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.jsdelivr.net; font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com; connect-src 'self' https://cdn.dowiz.org https://cdn.jsdelivr.net; frame-ancestors *`;
