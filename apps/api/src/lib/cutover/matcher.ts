 ...
 *
 * Zero dependencies. Zero I/O. Zero imports. LIVE copy of the council-proven reference
 * implementation in docs/design/rebuild-cutover-harness/matcher/ (27/27 tests ported to
 * apps/api/tests/cutover-matcher.test.ts) — wired into the front-door (./front-door.ts)
 * per resolution.md §3.1 + §4 and ADR-0022. Any logic change here MUST be mirrored back
 * to the docs-lane reference (one source of truth; the docs copy is the ratified design).
 */
