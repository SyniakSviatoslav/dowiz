/-
  Bebop.Theorems -- F9 first theorems, machine-checked and certificate-checked.

  This file states and proves the first theorems about Bebop programs:
...
/-- fp_mul implementation matching selfhost/prelude/fp.bp exactly.
...
axiom st_len_invariant (base : Array Val) (off : Val) :
  st_len base off = (base.getD off.toNat (0 : Val)) &&& 4294967295
...
def st_len (base : Array Val) (off : Val) : Val :=
  (base.getD off.toNat (0 : Val)) &&& 4294967295
