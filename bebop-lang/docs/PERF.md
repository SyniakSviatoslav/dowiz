...
Status: 2026-09-06 CURRENT (last 3 runs; `!` = alert: > T % and > 3 MAD vs the previous valid row of another binary; `?` = invalid window: throttled / busy box; exact counts gate with word_budget.txt)

| metric | unit | 5ec3152/e14dd55e | f86bee7/e14dd55e | 01185e7/e14dd55e | last delta |
|---|---|---|---|---|---|
| battery_flakes | count | 0 | 0 | 0 | first |
| gate_run_ms | ms | 0 | 0 | 0 | first |
| chain_wall | s | 18 | 16 | 24 | first |
| chain_cpu | s | 27.63 | 26.4 | 28.79 | first |
| bin_words | words | 74804 | 74804 | 74804 | 74804 -> 74804 |
| stub_words | words | 131 | 131 | 131 | 131 -> 131 |
| bin_fns | fns | 199 | 199 | 199 | first |
...
| fuzz_seeds_on_bin | seeds | 1000 | 3000 | 4000 | first |
| fuzz_rate | prog/s | 1.6 | 1.58 | 1.58 | first |
| fuzz_trap_unpredicted | count | 7 | 15 | 24 | first |
| selfcompile_wall | ms | 1569 ? | 1567 ? | 1479 ? | invalid window |
| selfcompile_utime | s | 1.529 ? | 1.522 ? | 1.432 ? | invalid window |
| selfcompile_stime | s | 0.02 ? | 0.0278 ? | 0.0199 ? | invalid window |
| selfcompile_maxrss | kB | 23000 ? | 22988 ? | 23000 ? | invalid window |
| selfcompile_energy | core-s@fmax (proxy) | 1.633 ? | 1.626 ? | 1.691 ? | invalid window |
| k1h_ms | ms/rep | 1.64 ? | 1.59 | 1.54 ? | invalid window |
| k1h_loopwords | words | 11 | 11 | 11 | 11 -> 11 |
| k2h_ms | ms/rep | 1.18 ? | 1.09 | 1.08 ? | invalid window |
| k2h_loopwords | words | 65 | 65 | 65 | 65 -> 65 |
| k3h_ms | ms/rep | 0.54 ? | 0.52 | 0.53 ? | invalid window |
| k3h_loopwords | words | 25 | 25 | 25 | 25 -> 25 |
| k4_ms | ms/rep | 4.04 ? | 3.75 | 3.77 ? | invalid window |
| k4_loopwords | words | 15 | 15 | 15 | 15 -> 15 |
| proc_floor_ms | ms | 23 |  |  | first |
| becache_warm_ms | ms | 36 |  |  | first |
| becache_cold_ms | ms | 48 |  |  | first |
| fuzz_trap82 | count |  |  | 0 | 0 TRAP-82 (SIGSEGV/SIGBUS) on e14dd55e, 0 tolerated |
