...
| 7 | parallel per-fn codegen | SKIP | emission is 0.93 of 1.45 s, ideal 3x on 3 cores = ~0.85 s total, high risk (shared arena/T126, fntab mutated during emission, <= 8 live symbols in the clone fn) |
