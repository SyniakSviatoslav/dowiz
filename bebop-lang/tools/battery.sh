...
line f7_kcheck.log '^kernel_neg:' ' 0 accepted of 16'  # F7: twin soundness (Python reference)
line f7_kcheck.log '^kernel_neg_bin:' ' 0 accepted of 16'  # F7: kernel binary soundness (must reject all unsound terms)
line f7_kcheck.log '^kernel_parity:' '21/21'  # F7: kernel parity measurement (must be real, not "NOT MEASURED")
