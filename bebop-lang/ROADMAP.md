...
| A4 | window OPENED 2026-09-07 ~18:00 on e9159318 (operator: before A2b/A3; any later codegen promotion restarts the count on its own md5) -- 24 h fuzz freeze window (process, no code): fuzzd on the promoted md5 until fuzz_seeds_on_bin >= 10^5 | docs/blueprints/A4-fuzz-freeze.md | 0 CRASH/DIVERGE, TRAP-82 = 0 | A1-A3 |
