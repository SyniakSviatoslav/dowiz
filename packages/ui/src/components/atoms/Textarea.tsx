  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <textarea
        ...
        className={`w-full px-4 py-2.5 bg-brand-surface border rounded-[var(--brand-radius-sm)] text-brand-text placeholder-brand-text-muted font-body resize-y transition-[border-color,box-shadow] duration-150 ease-[var(--ease-soft)] motion-reduce:transition-none hover:border-brand-text-muted/60 focus:outline-none focus:ring-2 ${
