            ...
            >
              <span className="relative inline-flex text-xl mb-1">
                ...
                {tab.label === 'Tasks' && tasksCount > 0 && (
                  <span className="absolute -top-1.5 -right-2.5 min-w-[16px] h-[16px] rounded-full bg-[var(--color-danger)] text-white text-[9px] font-bold flex items-center justify-center leading-none px-1 shadow-md">
