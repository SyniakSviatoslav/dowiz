...
/**
 * ADR-0002 Phase 2 (start) · read_public_menu reads products.primary_media_id.
 *
 * Phase 1 deferred this (resolution C2): with primary_media_id always NULL the change was
 * pure transcription risk and zero benefit. Phase 2 introduces real non-NULL media, so the
...
export async function down(): Promise<void> {
  // Forward-only. The added field is additive (null when unset); no need to revert.
}
