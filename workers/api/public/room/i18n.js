...
export const T = {
  sq: {
    ...
    tipsTitle: 'Bakshishet sipas personit', tipsHint: 'Kush mori sa bakshish në këtë periudhë të arkës. Pa ndarje.', tipsNone: 'Asnjë bakshish në këtë periudhë.', tipsFailed: 'Bakshishet nuk u ngarkuan.',
  ...
  en: {
    ...
    tipsTitle: 'Tips by person', tipsHint: 'Who took how much in tips over this till period. No sharing out.', tipsNone: 'No tips in this period.', tipsFailed: 'The tips did not load.',
  ...
  uk: {
    ...
    tipsTitle: 'Чайові по людях', tipsHint: 'Хто скільки взяв чайових за цей період каси. Без розподілу.', tipsNone: 'За цей період чайових немає.', tipsFailed: 'Чайові не завантажились.',
