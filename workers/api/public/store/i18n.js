...
export const T = {
  sq: { privacy:'Njoftimi i privatësisë', cart:'Shporta', add:'Shto', total:'Totali', chargedIn:'Do të paguhet', checkout:'Vazhdo', empty:'Shporta është bosh',
        ...
        bkRoom:'Salla',
        tblTable:'Tavolina', tblAt:'Porosia shkon te', tblBill:'Llogaria e tavolinës', tblWait:'Një kamerier do ta konfirmojë porosinë tuaj.',
        stampCard:'Karta e vulave', stampRule:'Karta e plotë zbret nga porosia e radhës:', stampUsed:'Karta e plotë në këtë porosi:',
  ...
  en: { privacy:'Privacy notice', cart:'Cart', add:'Add', total:'Total', chargedIn:'You will be charged', checkout:'Checkout', empty:'Your cart is empty',
        ...
        bkRoom:'Room',
        tblTable:'Table', tblAt:'Ordering to', tblBill:'The table\'s bill', tblWait:'A waiter will confirm your order.',
        stampCard:'Stamp card', stampRule:'A full card takes off your next order:', stampUsed:'A full card on this order:',
  ...
  uk: { privacy:'Конфіденційність', cart:'Кошик', add:'Додати', total:'Разом', chargedIn:'Буде списано', checkout:'Оформити', empty:'Кошик порожній',
        ...
        bkRoom:'Зал',
        tblTable:'Столик', tblAt:'Замовлення до', tblBill:'Рахунок столика', tblWait:'Офіціант підтвердить ваше замовлення.',
        stampCard:'Картка штампів', stampRule:'Повна картка знімає з наступного замовлення:', stampUsed:'Повна картка на цьому замовленні:',
