...
export const T = {
  sq: { cart:'Shporta', add:'Shto', total:'Totali', chargedIn:'Do të paguhet', checkout:'Vazhdo', empty:'Shporta është bosh',
        ...
        mapLegend:'Rruga e porosisë', mapVenue:'lokali', mapYou:'ju', mapCourier:'korrieri', episode:'Porosia', stepOf:'hapi', ofSteps:'nga', whatTheySay:'Çfarë thonë të tjerët', nextUp:'Më pas', preparingTitle:'Po gatuhet për ju',
        installApp:'Instaloni si aplikacion', installHint:'Në Safari: Ndaj → Shto në ekranin kryesor', installed:'U instalua',
  ...
  en: { cart:'Cart', add:'Add', total:'Total', chargedIn:'You will be charged', checkout:'Checkout', empty:'Your cart is empty',
        ...
        mapLegend:'The way to you', mapVenue:'venue', mapYou:'you', mapCourier:'courier', episode:'Order', stepOf:'step', ofSteps:'of', whatTheySay:'What people say', nextUp:'Up next', preparingTitle:'Being made for you',
        installApp:'Install as an app', installHint:'In Safari: Share → Add to Home Screen', installed:'Installed',
  ...
  uk: { cart:'Кошик', add:'Додати', total:'Разом', chargedIn:'Буде списано', checkout:'Оформити', empty:'Кошик порожній',
        ...
        mapLegend:'Шлях замовлення', mapVenue:'заклад', mapYou:'ви', mapCourier:'кур’єр', episode:'Замовлення', stepOf:'крок', ofSteps:'з', whatTheySay:'Що кажуть гості', nextUp:'Далі', preparingTitle:'Готується для вас',
        installApp:'Встановити як додаток', installHint:'У Safari: Поділитися → На Початковий екран', installed:'Встановлено',
