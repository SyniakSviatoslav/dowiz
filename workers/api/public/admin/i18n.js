...
export const T = {
  sq: {
    // the till link (ebills.al), 2026-09-23
    exceptions:'Përjashtimet', exceptionsSub:'anulime, dhurata, rimbursime', ebills:'Arka (ebills)', ebillsSub:'shitjet në tavolinë', ebillsHint:'Shitjet në tavolinë nga ebills.al hyjnë këtu vetë, pranë porosive me dërgesë, dhe zbresin nga e njëjta magazinë. Vetëm lexim: dowiz nuk shkruan asgjë në ebills.', eb_live:'lidhur', eb_failing:'gabim', eb_halted:'ndalur', eb_lastOk:'Leximi i fundit', eb_lastError:'Gabimi i fundit', eb_never:'ende asnjëherë', eb_imported:'Të importuara', eb_placed:'porosi', eb_paid:'të paguara', eb_noted:'të ndryshuara', eb_pending:'Fatura që presin pjatat', eb_short:'Magazina nën zero', eb_refused:'Shitje të refuzuara', eb_unmatched:'Kode pa pjatë', eb_unmatchedHint:'Lidhni çdo kod të arkës me pjatën e menysë. Vetëm pjatat e lidhura zbresin magazinen. Sugjerimet janë sipas emrit; asgjë nuk lidhet vetë.', eb_allMatched:'Çdo kod i parë është lidhur.', eb_mapped:'Kode të lidhura', eb_map:'Lidh', eb_clear:'Hiq', eb_pick:'Zgjidhni pjatën', eb_priceDiffers:'çmim tjetër', eb_floor:'Salla sipas arkës', eb_settings:'Lidhja', eb_enabled:'Lexo nga ebills', eb_enabledHint:'Salla çdo minutë, shitjet çdo 5 minuta kur lokali është hapur.', eb_user:'Përdoruesi ebills', eb_pos:'Pika e shitjes (ID)', eb_password:'Fjalëkalimi', eb_passwordSet:'i ruajtur; shkruani për ta ndryshuar', eb_forget:'Shkëput (fshi fjalëkalimin)', eb_forgotten:'Lidhja u shkëput.', eb_roleHint:'Për leximin mjafton një përdorues me të drejta raportesh (ROLE_REPORT); dërgimi i faturave kërkon ROLE_SALE. Jo administratorin.', table:'Tavolina',
    // fiscal sending to ebills.al (card L70), 2026-09-24
    fx_title:'Dërgimi fiskal', fx_hint:'Dërgimi i faturave fiskale nga dowiz në ebills.al është i fikur për platformën. Importi nga arka (ebills -> dowiz) punon si zakonisht.', fx_armed:'aktiv', fx_off:'joaktiv', fx_lastOk:'Dërgimi i fundit', fx_lastError:'Gabimi i fundit', fx_backlog:'Në pritje', fx_overdue:'me afat të kaluar', fx_sent:'të regjistruara', fx_waiting:'Porositë në pritje', fx_none:'Asnjë porosi në pritje.', fx_receipt:'Fatura', fx_deadline:'afati', fx_stage_queued:'në radhë', fx_stage_sending:'po dërgohet', fx_stage_unfiscalised:'pa fiskalizim', fx_stage_refused:'e refuzuar', fx_stage_blocked:'e bllokuar', fx_stage_inconclusive:'kontrolloni në ebills', fx_setup:'Cilësimet', fx_saleUnit:'Njësia e shitjes në ebills', fx_pick:'Zgjidhni', fx_saleUnitHint:'Krijoni në ebills një tavolinë p.sh. DELIVERY; çdo faturë e dowiz dërgohet me të.', fx_feeItem:'Artikulli për tarifën e dërgesës', fx_noFee:'Asnjë (porositë me tarifë nuk dërgohen)', fx_arming:'Aktivizimi', fx_consequence:'Pas aktivizimit, çdo porosi që merr para dërgohet në ebills.al si faturë fiskale. Çdo dërgim është akt ligjor në autoritetin tatimor dhe korrigjohet vetëm me faturë korrigjuese.', fx_marker:'Shënimi i faturës (mund të shtypet):', fx_typePhrase:'Për ta aktivizuar, shkruani saktë:', fx_arm:'Aktivizo dërgimin', fx_disarm:'Ndalo dërgimin', fx_cancelState:'Anulimi në ebills:', fx_cancelsQueued:'anulime në radhë', fx_armedNow:'Dërgimi fiskal u aktivizua.', fx_disarmedNow:'Dërgimi fiskal u ndal.', fx_open:'Hap', fx_openHint:'fatura fiskale në ebills',
    // F1: supplies and recipes in bulk, 2026-09-24
    importCsv:'Importo CSV', importSupplies:'Importo përbërësit', importRecipes:'Importo recetat', bulkSuppliesHint:'CSV me kolonat emri, lloji, njësia (g, kg, ml, l, copë), kalori, proteina, yndyra, karbohidrate, kosto, për, furnitori, minimumi. 1.200,00 dhe 1200 janë i njëjti numër; kostoja në lekë të plota. Së pari provë, pastaj zbato.', bulkRecipesHint:'CSV me kolonat pjata, përbërës, sasia, njësia: një rresht për çdo përbërës të një porcioni. Pjata dhe përbërësi gjenden sipas emrit. Një pjatë me një rresht të palexueshëm nuk merr recetë. Importoni përbërësit më parë.', bulkNew:'i ri', bulkSupplyN:'përbërës', bulkRecipeN:'receta', bulkWithout:'pa recetë', bulkNow:'tani', bulkThen:'pas', bulkLines:'rreshta', bulkWritten:'U shkruan', bulkFlattened:'gjysmëprodukte të shpërbëra', bulkRetireMissing:'Hiq nga lista përbërësit që mungojnë në skedar', bulkRetireHint:'Historia mbetet dhe recetat vazhdojnë t\'i rezervojnë.',
    ...
    promosSub:'kode zbritjeje', stampCard:'Karta e vulave', stampHint:'Çdo porosi e dorëzuar ose e marrë, dhe çdo tavolinë e paguar, është një vulë. Karta e plotë zbret shumën nga porosia e radhës. Shfaqet vetëm në faqen e porosisë së klientit; askujt nuk i dërgohet mesazh.', stampOn:'Karta e vulave aktive', stampN:'Vula për kartë të plotë (2-20)', stampReward:'Zbritja e kartës së plotë', postsSub:'drafte për kanalet', socialSub:'Telegram, Instagram', analyticsSub:'7 dhe 30 ditë', customersSub:'të maskuar', venueSub:'emri, telefoni, adresa', hoursSub:'orari javor', deliveryTermsSub:'tarifa, minimumi', paymentsSub:'kartë, kripto', notificationsSub:'Telegram, WhatsApp', channelsSub:'nga vjen porosia', mcpSub:'agjentët', cloudSub:'kopje çdo natë', brandingSub:'ngjyra, vula', featuresSub:'ndez / fik', apiKeysSub:'për partnerët', activationSub:'gati për punë?', healthSub:'imazhet, kopja', integrationsSub:'provo çdo lidhje', assistantSub:'pyet për lokalin', inboxSub:'WhatsApp, Instagram', previewSub:'si e sheh klienti',
    dpa:'Marrëveshja e të dhënave', dpaSub:'dowiz si përpunues', dpaHint:'dowiz i trajton të dhënat e klientëve tuaj vetëm sipas kësaj marrëveshjeje (Ligji 124/2024 neni 26). Lexojeni dhe pranojeni në emër të lokalit.', dpaRead:'Lexo marrëveshjen', dpaAgree:'E lexova dhe e pranoj në emër të lokalit', dpaAccept:'Prano', dpaCurrent:'e pranuar', dpaMissing:'e papranuar', dpaOld:'version i ri pret', dpaAccepted:'Pranuar',
    ...
    language:'Gjuha', retry:'Provo përsëri', loading:'Po ngarkohet…', sendReply:'Dërgo', deliveryArea:'Zona e dorëzimit', learnGroup:'Mëso', learn:'Mësimet', learnSub:'Ture të konsolës, me video', learnNew:'I ri', learnDone:'Mbaruar', learnPaused:'Në pauzë', learnWatch:'Shiko videon', learnWrites:'ndryshon të dhëna reale', learnSteps:'{n} hapa', learnEmpty:'Ky mësim nuk u gjet', learnOffline:'Mësimet duan lidhje interneti', save:'Ruaj', saved:'U ruajt', cancel:'Anulo', done:'Në rregull',
    ...
    // tabs
    tabOrders:'Porositë', tabMenu:'Menyja', tabStock:'Përbërësit & magazina', tabCouriers:'Korrierët', tabMore:'Lokali',
    // venue state
    ...
    newOrder:'Porosi e re', order:'Porosia', items:'Artikuj', customer:'Klienti', address:'Adresa', pickup:'Marrje vetë', delivery:'Dërgesë', dineIn:'Në lokal',
    note:'Shënim', payment:'Pagesa', total:'Totali', tip:'Bakshish', when:'Kur', asap:'Sa më shpejt', courier:'Korrieri', assign:'Cakto',
    tableQr:'Kodet QR të tavolinave', tableQrSub:'porosi nga tavolina',
    roomGroup:'Salla', bookings:'Rezervimet', bookingsSub:'dita, konfirmo, ul, anulo', floorPlan:'Plani i sallës', floorPlanSub:'sallat dhe tavolinat',
    printer:'Printeri i kuzhinës', printerSub:'fletët e porosive', print_queued:'Në radhë për printim', print_printing:'Po printohet', print_printed:'Printuar', print_failed:'Printimi dështoi',
    campaigns:'Fushatat', campaignsSub:'vetëm me pëlqim, në WhatsApp',
    markSeen:'E pashë', seenAt:'Parë', seenFail:'Shenja e parë nuk u ruajt', kitchenUnseen:'Fletë që kuzhina nuk i ka parë',
    accept:'Prano', startCooking:'Fillo gatimin', markReady:'Gati', markCollected:'U mor', handToCourier:'Jepja korrierit', delivered:'U dorëzua', reject:'Refuzo',
    foodBack:'Ushqimi u kthye', foodBackHint:'Refuzuar te dera. Zgjidhni një herë.', resell:'Kthe në stok', wasteIt:'Hidhe', foodBackDone:'U regjistrua', refusedNote:'Shënimi i korrierit',
    ...
    st:{PENDING:'E re',CONFIRMED:'Pranuar',PREPARING:'Po gatuhet',READY:'Gati',IN_DELIVERY:'Në rrugë',DELIVERED:'Dorëzuar',
        ...
        REFUNDING:'Po kthehet',COMPENSATED_REFUND:'U kthye'},
    pay:{cash:'Para në dorë',card:'Kartë',apple_pay:'Apple Pay',google_pay:'Google Pay',crypto:'Kripto',platform:'Paguar te platforma'},
    // menu
    ...
    previewH:'Parapamje e vitrinës', previewP:'Kështu e sheh klienti vitrinën në telefon. Ndryshimet e menysë shfaqen pasi t\'i ruani.', previewReload:'Rifresko', previewOpen:'Hap vitrinën',
  ...
  en: {
    // the till link (ebills.al), 2026-09-23
    exceptions:'Exceptions', exceptionsSub:'voids, comps, refunds', ebills:'Till (ebills)', ebillsSub:'dine-in sales', ebillsHint:'Dine-in sales from ebills.al arrive here by themselves, beside the delivery orders, and draw on the same stock. Read-only: dowiz writes nothing to ebills.', eb_live:'connected', eb_failing:'failing', eb_halted:'stopped', eb_lastOk:'Last read', eb_lastError:'Last error', eb_never:'not yet', eb_imported:'Imported', eb_placed:'orders', eb_paid:'paid', eb_noted:'changed', eb_pending:'Bills waiting for their dishes', eb_short:'Stock below zero', eb_refused:'Refused sales', eb_unmatched:'Codes with no dish', eb_unmatchedHint:'Match each till code to a menu dish. Only matched dishes draw stock. Suggestions go by name; nothing is matched for you.', eb_allMatched:'Every code seen so far is matched.', eb_mapped:'Matched codes', eb_map:'Match', eb_clear:'Remove', eb_pick:'Choose a dish', eb_priceDiffers:'other price', eb_floor:'The room, as the till sees it', eb_settings:'Connection', eb_enabled:'Read from ebills', eb_enabledHint:'The room every minute, sales every 5 minutes while the venue is open.', eb_user:'ebills user', eb_pos:'Point of sale (ID)', eb_password:'Password', eb_passwordSet:'saved; type to change it', eb_forget:'Disconnect (forget the password)', eb_forgotten:'The till link is disconnected.', eb_roleHint:'Reading needs only a user with report rights (ROLE_REPORT); sending invoices needs ROLE_SALE. Not the administrator.', table:'Table',
    // fiscal sending to ebills.al (card L70), 2026-09-24
    fx_title:'Fiscal sending', fx_hint:'Sending fiscal invoices from dowiz to ebills.al is switched off for the platform. The till import (ebills -> dowiz) works as usual.', fx_armed:'armed', fx_off:'off', fx_lastOk:'Last send', fx_lastError:'Last error', fx_backlog:'Waiting', fx_overdue:'past deadline', fx_sent:'registered', fx_waiting:'Orders waiting', fx_none:'No order is waiting.', fx_receipt:'Receipt', fx_deadline:'deadline', fx_stage_queued:'queued', fx_stage_sending:'sending', fx_stage_unfiscalised:'not fiscalised', fx_stage_refused:'refused', fx_stage_blocked:'blocked', fx_stage_inconclusive:'check ebills', fx_setup:'Setup', fx_saleUnit:'ebills sale unit', fx_pick:'Choose', fx_saleUnitHint:'Create a table in ebills, e.g. DELIVERY; every dowiz invoice is sent with it.', fx_feeItem:'Item for the delivery fee', fx_noFee:'None (orders with a fee are not sent)', fx_arming:'Arming', fx_consequence:'Once armed, every order that takes money is sent to ebills.al as a fiscal invoice. Each send is a legal act at the tax authority and is corrected only by a corrective invoice.', fx_marker:'Invoice note (may print on the receipt):', fx_typePhrase:'To arm, type exactly:', fx_arm:'Arm sending', fx_disarm:'Stop sending', fx_cancelState:'Cancel at ebills:', fx_cancelsQueued:'cancels queued', fx_armedNow:'Fiscal sending is armed.', fx_disarmedNow:'Fiscal sending is stopped.', fx_open:'Open', fx_openHint:'fiscal invoices to ebills',
    // F1: supplies and recipes in bulk, 2026-09-24
    importCsv:'Import CSV', importSupplies:'Import supplies', importRecipes:'Import recipes', bulkSuppliesHint:'A CSV with columns name, kind, unit (g, kg, ml, l, pcs), kcal, protein, fat, carbs, cost, per, supplier, low_at. 1.200,00 and 1200 are the same number; cost in whole lek. Dry run first, then apply.', bulkRecipesHint:'A CSV with columns dish, ingredient, qty, unit: one row per ingredient of one portion. Dish and ingredient are found by name. A dish with any unreadable row gets no recipe. Import the supplies first.', bulkNew:'new', bulkSupplyN:'supplies', bulkRecipeN:'recipes', bulkWithout:'without a recipe', bulkNow:'now', bulkThen:'after', bulkLines:'lines', bulkWritten:'Written', bulkFlattened:'semi-finished products expanded', bulkRetireMissing:'Take off the list the supplies missing from the file', bulkRetireHint:'History is kept and recipes still reserve them.',
    // inventory as the old service had it, and the recipe
    ...
    promosSub:'discount codes', stampCard:'Stamp card', stampHint:'Every delivered or collected order, and every paid table, is a stamp. A full card takes the amount off the next order. Shown only on the customer order page; no message is ever sent.', stampOn:'Stamp card on', stampN:'Stamps for a full card (2-20)', stampReward:'A full card takes off', postsSub:'drafts for channels', socialSub:'Telegram, Instagram', analyticsSub:'7 and 30 days', customersSub:'masked', venueSub:'name, phone, address', hoursSub:'weekly schedule', deliveryTermsSub:'fee, minimum', paymentsSub:'card, crypto', notificationsSub:'Telegram, WhatsApp', channelsSub:'where orders come from', mcpSub:'agents', cloudSub:'a copy every night', brandingSub:'colours, seal', featuresSub:'on / off', apiKeysSub:'for partners', activationSub:'ready to work?', healthSub:'images, backup', integrationsSub:'prove every connection', assistantSub:'ask about the venue', inboxSub:'WhatsApp, Instagram', previewSub:'as a customer sees it',
    dpa:'Data agreement', dpaSub:'dowiz as processor', dpaHint:'dowiz handles your customers\' data only under this agreement (Law 124/2024 Art. 26). Read it and accept it for the venue.', dpaRead:'Read the agreement', dpaAgree:'I have read it and accept it for the venue', dpaAccept:'Accept', dpaCurrent:'accepted', dpaMissing:'not accepted', dpaOld:'a new version is waiting', dpaAccepted:'Accepted',
    ...
    tabOrders:'Orders', tabMenu:'Menu', tabStock:'Ingredients & stock', tabCouriers:'Couriers', tabMore:'Venue',
    ...
    newOrder:'New order', order:'Order', items:'Items', customer:'Customer', address:'Address', pickup:'Pickup', delivery:'Delivery', dineIn:'In the venue',
    note:'Note', payment:'Payment', total:'Total', tip:'Tip', when:'When', asap:'As soon as possible', courier:'Courier', assign:'Assign',
    tableQr:'Table QR codes', tableQrSub:'ordering at the table',
    roomGroup:'The room', bookings:'Bookings', bookingsSub:'the day: confirm, seat, cancel', floorPlan:'Floor plan', floorPlanSub:'rooms and tables',
    printer:'Kitchen printer', printerSub:'order tickets', print_queued:'Queued to print', print_printing:'Printing', print_printed:'Printed', print_failed:'Print failed',
    campaigns:'Campaigns', campaignsSub:'consented only, on WhatsApp',
    markSeen:'Seen', seenAt:'Seen', seenFail:'The seen mark was not saved', kitchenUnseen:'Tickets the kitchen has not seen',
    accept:'Accept', startCooking:'Start cooking', markReady:'Ready', markCollected:'Collected', handToCourier:'Hand to courier', delivered:'Delivered', reject:'Reject',
    foodBack:'Food came back', foodBackHint:'Refused at the door. Choose once.', resell:'Back to stock', wasteIt:'Throw away', foodBackDone:'Recorded', refusedNote:'Courier note',
    ...
    st:{PENDING:'New',CONFIRMED:'Accepted',PREPARING:'Cooking',READY:'Ready',IN_DELIVERY:'On the way',DELIVERED:'Delivered',
        ...
        REFUNDING:'Refunding',COMPENSATED_REFUND:'Refunded'},
    ...
    previewH:'Storefront preview', previewP:'This is the storefront as a customer sees it on a phone. Menu changes show here after you save.', previewReload:'Reload', previewOpen:'Open storefront',
  ...
  uk: {
    // the till link (ebills.al), 2026-09-23
    exceptions:'Винятки', exceptionsSub:'скасування, компліменти, повернення', ebills:'Каса (ebills)', ebillsSub:'продажі в залі', ebillsHint:'Продажі в залі з ebills.al надходять сюди самі, поруч із замовленнями з доставкою, і списують той самий склад. Лише читання: dowiz нічого не пише в ebills.', eb_live:'підключено', eb_failing:'помилка', eb_halted:'зупинено', eb_lastOk:'Останнє читання', eb_lastError:'Остання помилка', eb_never:'ще жодного', eb_imported:'Імпортовано', eb_placed:'замовлень', eb_paid:'оплачено', eb_noted:'змінено', eb_pending:'Рахунки, що чекають страв', eb_short:'Склад нижче нуля', eb_refused:'Відхилені продажі', eb_unmatched:'Коди без страви', eb_unmatchedHint:'Зіставте кожен код каси зі стравою меню. Склад списують лише зіставлені страви. Підказки за назвою; нічого не зіставляється само.', eb_allMatched:'Кожен побачений код зіставлено.', eb_mapped:'Зіставлені коди', eb_map:'Зіставити', eb_clear:'Прибрати', eb_pick:'Оберіть страву', eb_priceDiffers:'інша ціна', eb_floor:'Зал очима каси', eb_settings:'Підключення', eb_enabled:'Читати з ebills', eb_enabledHint:'Зал щохвилини, продажі кожні 5 хвилин, поки заклад відчинено.', eb_user:'Користувач ebills', eb_pos:'Точка продажу (ID)', eb_password:'Пароль', eb_passwordSet:'збережено; введіть, щоб змінити', eb_forget:'Від\'єднати (забути пароль)', eb_forgotten:'Касу від\'єднано.', eb_roleHint:'Для читання досить користувача з правом звітів (ROLE_REPORT); для надсилання чеків потрібен ROLE_SALE. Не адміністратора.', table:'Стіл',
    // fiscal sending to ebills.al (card L70), 2026-09-24
    fx_title:'Фіскальна відправка', fx_hint:'Надсилання фіскальних чеків з dowiz в ebills.al вимкнено для платформи. Імпорт з каси (ebills -> dowiz) працює як завжди.', fx_armed:'увімкнено', fx_off:'вимкнено', fx_lastOk:'Остання відправка', fx_lastError:'Остання помилка', fx_backlog:'Чекають', fx_overdue:'прострочено', fx_sent:'зареєстровано', fx_waiting:'Замовлення в черзі', fx_none:'Жодне замовлення не чекає.', fx_receipt:'Чек', fx_deadline:'строк', fx_stage_queued:'у черзі', fx_stage_sending:'надсилається', fx_stage_unfiscalised:'не фіскалізовано', fx_stage_refused:'відхилено', fx_stage_blocked:'заблоковано', fx_stage_inconclusive:'перевірте в ebills', fx_setup:'Налаштування', fx_saleUnit:'Одиниця продажу в ebills', fx_pick:'Оберіть', fx_saleUnitHint:'Створіть у ebills стіл, напр. DELIVERY; кожен чек dowiz надсилається з ним.', fx_feeItem:'Позиція для плати за доставку', fx_noFee:'Немає (замовлення з платою не надсилаються)', fx_arming:'Увімкнення', fx_consequence:'Після увімкнення кожне замовлення з оплатою надсилається в ebills.al як фіскальний чек. Кожна відправка - юридична дія в податковій і виправляється лише коригувальним чеком.', fx_marker:'Примітка чека (може друкуватися):', fx_typePhrase:'Щоб увімкнути, введіть точно:', fx_arm:'Увімкнути відправку', fx_disarm:'Зупинити відправку', fx_cancelState:'Скасування в ebills:', fx_cancelsQueued:'скасувань у черзі', fx_armedNow:'Фіскальну відправку ввімкнено.', fx_disarmedNow:'Фіскальну відправку зупинено.', fx_open:'Відкрити', fx_openHint:'фіскальні чеки в ebills',
    // F1: supplies and recipes in bulk, 2026-09-24
    importCsv:'Імпорт CSV', importSupplies:'Імпортувати інгредієнти', importRecipes:'Імпортувати рецепти', bulkSuppliesHint:'CSV з колонками назва, тип, одиниця (g, kg, ml, l, шт), калорії, білки, жири, вуглеводи, собівартість, за, постачальник, мінімум. 1.200,00 і 1200 це одне число; вартість у цілих леках. Спершу пробний запуск, потім застосуйте.', bulkRecipesHint:'CSV з колонками страва, інгредієнт, кількість, од.: рядок на кожен інгредієнт однієї порції. Страву й інгредієнт знаходимо за назвою. Страва з хоч одним нечитабельним рядком рецепта не отримує. Спершу імпортуйте інгредієнти.', bulkNew:'новий', bulkSupplyN:'інгредієнтів', bulkRecipeN:'рецептів', bulkWithout:'без рецепта', bulkNow:'зараз', bulkThen:'після', bulkLines:'рядків', bulkWritten:'Записано', bulkFlattened:'напівфабрикатів розкладено', bulkRetireMissing:'Зняти зі списку інгредієнти, яких немає у файлі', bulkRetireHint:'Історія лишається, рецепти й далі їх резервують.',
    // inventory as the old service had it, and the recipe
    ...
    promosSub:'коди знижок', stampCard:'Картка штампів', stampHint:'Кожне доставлене чи забране замовлення і кожен оплачений стіл - це штамп. Повна картка знімає суму з наступного замовлення. Видно лише на сторінці замовлення клієнта; жодних повідомлень нікому.', stampOn:'Картка штампів увімкнена', stampN:'Штампів на повну картку (2-20)', stampReward:'Повна картка знімає', postsSub:'чернетки для каналів', socialSub:'Telegram, Instagram', analyticsSub:'7 і 30 днів', customersSub:'замасковані', venueSub:'назва, телефон, адреса', hoursSub:'тижневий графік', deliveryTermsSub:'вартість, мінімум', paymentsSub:'картка, крипто', notificationsSub:'Telegram, WhatsApp', channelsSub:'звідки замовлення', mcpSub:'агенти', cloudSub:'копія щоночі', brandingSub:'кольори, печатка', featuresSub:'увімк / вимк', apiKeysSub:'для партнерів', activationSub:'готово до роботи?', healthSub:'образи, копія', integrationsSub:'перевірити кожне', assistantSub:'спитати про заклад', inboxSub:'WhatsApp, Instagram', previewSub:'як бачить клієнт',
    dpa:'Договір про дані', dpaSub:'dowiz як обробник', dpaHint:'dowiz обробляє дані ваших клієнтів лише за цим договором (Закон 124/2024 ст. 26). Прочитайте його і прийміть від імені закладу.', dpaRead:'Прочитати договір', dpaAgree:'Я прочитав(ла) і приймаю від імені закладу', dpaAccept:'Прийняти', dpaCurrent:'прийнято', dpaMissing:'не прийнято', dpaOld:'чекає нова версія', dpaAccepted:'Прийнято',
    ...
    assistant:'Асистент', ask:'Запитати', askHint:'Питання про живі дані закладу: замовлення, страви, резерви.', localModel:'Відповіла модель на цьому сервері', cloudModel:'Хмарна модель · дані клієнтів не надсилались', aiSettings:'Модель', aiEnabled:'Асистент увімкнено', aiEnabledHint:'Нічого нікуди не надсилається, поки це вимкнено.', aiEndpoint:'Endpoint (OpenAI-сумісний /v1)', aiModel:'Модель', aiToken:'Токен', aiNotHttps:'Асистент увімкнено, але адреса не https — хаб не може її викликати, тож кожне питання дає помилку.',
    // integrations 2026-09-19
    ...
    tabOrders:'Замовлення', tabMenu:'Меню', tabStock:'Інгредієнти та склад', tabCouriers:'Кур’єри', tabMore:'Заклад',
    ...
    newOrder:'Нове замовлення', order:'Замовлення', items:'Позиції', customer:'Клієнт', address:'Адреса', pickup:'Самовивіз', delivery:'Доставка', dineIn:'У закладі',
    note:'Коментар', payment:'Оплата', total:'Разом', tip:'Чайові', when:'Коли', asap:'Якнайшвидше', courier:'Кур’єр', assign:'Призначити',
    tableQr:'QR-коди столів', tableQrSub:'замовлення за столом',
    roomGroup:'Зала', bookings:'Бронювання', bookingsSub:'день: підтвердити, посадити, скасувати', floorPlan:'План зали', floorPlanSub:'зали та столи',
    printer:'Принтер кухні', printerSub:'чеки замовлень', print_queued:'У черзі на друк', print_printing:'Друкується', print_printed:'Надруковано', print_failed:'Друк не вдався',
    campaigns:'Розсилки', campaignsSub:'лише за згодою, у WhatsApp',
    markSeen:'Бачу', seenAt:'Побачено', seenFail:'Позначку не збережено', kitchenUnseen:'Чеки, яких кухня не бачила',
    accept:'Прийняти', startCooking:'Готувати', markReady:'Готово', markCollected:'Забрали', handToCourier:'Віддати кур’єру', delivered:'Доставлено', reject:'Відхилити',
    foodBack:'Їжа повернулась', foodBackHint:'Відмова біля дверей. Оберіть один раз.', resell:'Назад на склад', wasteIt:'Списати', foodBackDone:'Записано', refusedNote:'Примітка кур\'єра',
    ...
    st:{PENDING:'Нове',CONFIRMED:'Прийнято',PREPARING:'Готується',READY:'Готове',IN_DELIVERY:'У дорозі',DELIVERED:'Доставлено',
        ...
        REFUNDING:'Повертаємо',COMPENSATED_REFUND:'Повернено'},
    ...
    previewH:'Превʼю вітрини', previewP:'Так вітрину бачить клієнт на телефоні. Зміни в меню з\'являються тут після збереження.', previewReload:'Оновити', previewOpen:'Відкрити вітрину',
