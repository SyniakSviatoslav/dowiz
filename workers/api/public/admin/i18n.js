...
export const T = {
  sq: {
    ...
    exceptions:'Përjashtimet', exceptionsSub:'anulime, dhurata, rimbursime', ebills:'Arka (ebills)', ebillsSub:'shitjet në tavolinë', ebillsHint:'Shitjet në tavolinë nga ebills.al hyjnë këtu vetë, pranë porosive me dërgesë, dhe zbresin nga e njëjta magazinë. Vetëm lexim: dowiz nuk shkruan asgjë në ebills.', eb_live:'lidhur', eb_failing:'gabim', eb_halted:'ndalur', eb_lastOk:'Leximi i fundit', eb_lastError:'Gabimi i fundit', eb_never:'ende asnjëherë', eb_imported:'Të importuara', eb_placed:'porosi', eb_paid:'të paguara', eb_noted:'të ndryshuara', eb_pending:'Fatura që presin pjatat', eb_short:'Magazina nën zero', eb_refused:'Shitje të refuzuara', eb_unmatched:'Kode pa pjatë', eb_unmatchedHint:'Lidhni çdo kod të arkës me pjatën e menysë. Vetëm pjatat e lidhura zbresin magazinen. Sugjerimet janë sipas emrit; asgjë nuk lidhet vetë.', eb_allMatched:'Çdo kod i parë është lidhur.', eb_mapped:'Kode të lidhura', eb_map:'Lidh', eb_clear:'Hiq', eb_pick:'Zgjidhni pjatën', eb_priceDiffers:'çmim tjetër', eb_floor:'Salla sipas arkës', eb_settings:'Lidhja', eb_enabled:'Lexo nga ebills', eb_enabledHint:'Salla çdo minutë, shitjet çdo 5 minuta kur lokali është hapur.', eb_user:'Përdoruesi ebills', eb_pos:'Pika e shitjes (ID)', eb_password:'Fjalëkalimi', eb_passwordSet:'i ruajtur; shkruani për ta ndryshuar', eb_roleHint:'Përdorni një përdorues vetëm me të drejta raportesh (ROLE_REPORT), jo administratorin.', table:'Tavolina',
    ...
    print_queued:'Në radhë për printim', print_printing:'Po printohet', print_printed:'Printuar', print_failed:'Printimi dështoi',
  ...
  en: {
    ...
    print_queued:'Queued to print', print_printing:'Printing', print_printed:'Printed', print_failed:'Print failed',
  ...
  uk: {
    ...
    print_queued:'У черзі на друк', print_printing:'Друкується', print_printed:'Надруковано', print_failed:'Друк не вдався',
