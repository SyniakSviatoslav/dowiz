...
export const T = {
  sq: {
    ...
    verifyToken:'Fjala e verifikimit', verifyHint:'Çdo frazë; e njëjta vendoset te forma e webhook-ut në Meta.', appSecret:'Sekreti i aplikacionit (opsional)', webhookUrl:'URL e webhook-ut', webhookHint:'Ngjiteni te Meta → WhatsApp / Instagram → Webhooks, me fushat messages.',
  ...
  en: {
    ...
    verifyToken:'Verify token', verifyHint:'Any phrase; paste the same one into the webhook form in Meta.', appSecret:'App secret (optional)', webhookUrl:'Webhook URL', webhookHint:'Paste into Meta → WhatsApp / Instagram → Webhooks, subscribed to messages.',
  ...
  uk: {
    ...
    verifyToken:'Слово перевірки', verifyHint:'Будь-яка фраза; ту саму вставте у форму вебхука в Meta.', appSecret:'Секрет застосунку (необов’язково)', webhookUrl:'URL вебхука', webhookHint:'Вставте в Meta → WhatsApp / Instagram → Webhooks, з підпискою на messages.',
