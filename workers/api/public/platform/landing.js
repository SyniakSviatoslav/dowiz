...
const T = {
  uk: {
    ...
    lede: 'Агрегатори забирають 25–35% кожного замовлення. dowiz дає закладу власний додаток на власному домені — меню, оплата, кур\'єр наживо — за $50 на місяць.',
    ...
    a1t: '0% комісії', a1p: '$50 на місяць за заклад. Жодного відсотка з чека і жодного тарифу за доставку.',
    ...
    priceN: '$50', priceP: 'на місяць, за заклад',
    t2p: 'Жодного відсотка з чека, жодного тарифу за доставку. П\'ятдесят доларів на місяць — і сто відсотків кожного замовлення ваші, скільки б ви не продали.',
  ...
  en: {
    ...
    lede: 'Aggregators take 25–35% of every order. dowiz gives a venue its own app on its own domain — menu, payment, courier live on the map — for $50 a month.',
    ...
    a1t: '0% commission', a1p: '$50 a month per venue. No percentage of the bill and no delivery tariff.',
    ...
    priceN: '$50', priceP: 'a month, per venue',
    t2p: 'No percentage of the bill, no delivery tariff. Fifty dollars a month, and a hundred per cent of every order is yours however much you sell.',
  ...
  sq: {
    ...
    lede: 'Agregatorët marrin 25–35% të çdo porosie. dowiz i jep lokalit aplikacionin e vet në domenin e vet — menyja, pagesa, korrieri në hartë — për $50 në muaj.',
    ...
    a1t: '0% komision', a1p: '$50 në muaj për lokal. Asnjë përqindje nga fatura dhe asnjë tarifë dërgese.',
    ...
    priceN: '$50', priceP: 'në muaj, për lokal',
    t2p: 'Asnjë përqindje nga fatura, asnjë tarifë dërgese. Pesëdhjetë dollarë në muaj, dhe njëqind për qind e çdo porosie është juaja sado të shisni.',
