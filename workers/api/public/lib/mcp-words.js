...
const WORDS = {
  sq: {
    ...
    hintOwner: 'Lidhni Claude, Codex, Gemini ose cilindo agjent MCP me lokalin. Agjenti merr vetëm veglat e çelësit: çelësi juaj API jep veglat e pronarit; çdo punonjës dhe korrier krijon çelësin e vet në aplikacionin e vet dhe merr vetëm të drejtat e veta.',
    hintStaff: 'Lidhni Claude, Codex, Gemini ose cilindo agjent MCP me punën tuaj. Çelësi që krijoni këtu i jep agjentit vetëm atë që mund të bëni ju, dhe ndalon kur ju ndalon roli ose e revokoni.',
    hintCourier: 'Lidhni Claude, Codex, Gemini ose cilindo agjent MCP me turnin tuaj. Agjenti sheh vetëm porositë tuaja dhe ato të lira, si ju në aplikacion.',
    ...
    claudeCode: 'Claude Code', claudeDesktop: 'Claude Desktop', codex: 'Codex', gemini: 'Gemini CLI', generic: 'Çdo klient MCP',
    hintClaudeCode: 'Në terminal, një herë:', hintClaudeDesktop: 'Në claude_desktop_config.json (kërkon Node.js):',
    hintCodex: 'OpenAI Codex (CLI ose IDE), në ~/.codex/config.toml:', hintGemini: 'Google Gemini CLI, në terminal (ose në ~/.gemini/settings.json):', hintGeneric: 'Për çdo klient tjetër që flet MCP:',
  ...
  en: {
    title: 'AI agent (MCP)',
    hintOwner: 'Connect Claude, Codex, Gemini or any MCP agent to the venue. An agent gets only its key\'s tools: your API key gives the owner\'s tools; each member of staff and courier mints their own key in their own app and gets only their own rights.',
    hintStaff: 'Connect Claude, Codex, Gemini or any MCP agent to your work. The key you make here lets the agent do only what you can, and stops when your role does or when you revoke it.',
    hintCourier: 'Connect Claude, Codex, Gemini or any MCP agent to your shift. The agent sees only your orders and the free ones, as you do in the app.',
    ...
    claudeCode: 'Claude Code', claudeDesktop: 'Claude Desktop', codex: 'Codex', gemini: 'Gemini CLI', generic: 'Any MCP client',
    hintClaudeCode: 'In a terminal, once:', hintClaudeDesktop: 'In claude_desktop_config.json (needs Node.js):',
    hintCodex: 'OpenAI Codex (CLI or IDE), in ~/.codex/config.toml:', hintGemini: 'Google Gemini CLI, in a terminal (or in ~/.gemini/settings.json):', hintGeneric: 'For any other client that speaks MCP:',
  ...
  uk: {
    title: 'AI-агент (MCP)',
    hintOwner: 'Підключіть Claude, Codex, Gemini чи будь-який MCP-агент до закладу. Агент отримує лише інструменти свого ключа: ваш API-ключ дає інструменти власника; кожен працівник і кур\'єр створює власний ключ у своєму застосунку й отримує лише свої права.',
    hintStaff: 'Підключіть Claude, Codex, Gemini чи будь-який MCP-агент до своєї роботи. Ключ, створений тут, дозволяє агенту лише те, що можете ви, і перестає діяти разом із вашою роллю або коли ви його відкличете.',
    hintCourier: 'Підключіть Claude, Codex, Gemini чи будь-який MCP-агент до своєї зміни. Агент бачить лише ваші замовлення та вільні, як ви в застосунку.',
    ...
    claudeCode: 'Claude Code', claudeDesktop: 'Claude Desktop', codex: 'Codex', gemini: 'Gemini CLI', generic: 'Будь-який MCP-клієнт',
