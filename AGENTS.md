...
|---|---|---|
| **Auth & Server** | 5 | JWT lazy load, `loadEnv()` module-scope crash, `.env.example` RS256 docs, `IP_HASH_SALT` + remove old `JWT_SIGNING_SECRET`, backup_restore false-degraded |
