...
impl Value {
    ...
    pub fn sin(&self) -> Value {
        self.unary(crate::math::sin(self.data()), |g, a| g * crate::math::cos(a))
    }

    pub fn cos(&self) -> Value {
        self.unary(crate::math::cos(self.data()), |g, a| -g * crate::math::sin(a))
    }

    pub fn exp(&self) -> Value {
        let d = crate::math::exp(self.data());
        self.unary(d, move |g, _| g * d) // d/dx e^x = e^x
    }

    pub fn ln(&self) -> Value {
        self.unary(crate::math::ln(self.data()), |g, a| g / a)
    }
    ...
    pub fn pow(&self, p: f64) -> Value {
        ...
        self.unary(
            crate::math::powf(a, p),
            move |g, _| g * p * crate::math::powf(a, p - 1.0),
        )
    }

    pub fn tanh(&self) -> Value {
        let d = crate::math::tanh(self.data());
...
mod tests {
    ...
    fn chain_rule_sin_x2() {
        ...
        let f = x2.sin();
        f.backward();
        let expected = 2.0 * crate::math::cos(1.0_f64);
        assert!((f.data() - crate::math::sin(1.0_f64)).abs() < 1e-12);
