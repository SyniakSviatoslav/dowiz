...
impl GeoLocation {
    ...
    pub fn distance_km(&self, other: &GeoLocation) -> f64 {
        ...
        let a = crate::math::powi(crate::math::sin(d_lat / 2.0), 2)
            + crate::math::cos(self.lat.to_radians())
                * crate::math::cos(other.lat.to_radians())
                * crate::math::powi(crate::math::sin(d_lon / 2.0), 2);
        r * 2.0 * crate::math::asin(crate::math::sqrt(a))
    }
}
