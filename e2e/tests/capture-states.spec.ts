/* eslint-disable @typescript-eslint/no-explicit-any, local/no-empty-catch, local/no-raw-any -- test/spec/spike/helper code -- flagged strings are test data, selectors, logs, error codes and SQL, not user-facing UI copy; any/raw-any are deliberate test/integration seams */
