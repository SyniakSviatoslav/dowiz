/* eslint-disable @typescript-eslint/no-explicit-any, local/no-permissive-status-assertion, max-nested-callbacks -- test/spec/spike/helper code -- flagged strings are test data, selectors, logs, error codes and SQL, not user-facing UI copy; any/raw-any are deliberate test/integration seams */
