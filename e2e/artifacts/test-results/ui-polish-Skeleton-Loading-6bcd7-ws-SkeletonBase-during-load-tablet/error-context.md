...
- Name: ui-polish.spec.ts >> Skeleton Loading States >> analytics shows SkeletonBase during load
- Location: e2e\tests\ui-polish.spec.ts:262:3
...
Call log:
  - waiting for locator('h2') to be visible
    33 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
