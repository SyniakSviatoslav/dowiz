...
- Name: real-session-menu.spec.ts >> Real Session — Menu Rebuild Verification >> Client menu page shows products with Tabler icons
- Location: e2e\tests\real-session-menu.spec.ts:36:3
