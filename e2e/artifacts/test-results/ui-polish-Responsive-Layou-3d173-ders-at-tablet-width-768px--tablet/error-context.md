...
- Name: ui-polish.spec.ts >> Responsive Layout >> Admin Dashboard renders at tablet width (768px)
...
Call log:
  - waiting for locator('h2') to be visible
    41 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
