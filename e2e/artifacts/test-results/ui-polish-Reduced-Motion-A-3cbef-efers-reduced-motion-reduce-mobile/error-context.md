...
- Name: ui-polish.spec.ts >> Reduced Motion >> Admin Orders works with prefers-reduced-motion: reduce
- Location: e2e\tests\ui-polish.spec.ts:201:5
...
Call log:
  - waiting for locator('h2') to be visible
    42 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
