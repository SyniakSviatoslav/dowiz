...
- Name: ui-polish.spec.ts >> Reduced Motion >> Analytics works with prefers-reduced-motion: reduce
...
Call log:
  - waiting for locator('h2') to be visible
    - locator resolved to 2 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
