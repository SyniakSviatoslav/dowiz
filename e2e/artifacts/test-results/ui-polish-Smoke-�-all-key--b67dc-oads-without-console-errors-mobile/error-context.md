...
- Name: ui-polish.spec.ts >> Smoke � all key screens load without errors >> Analytics loads without console errors
...
Call log:
  - waiting for locator('h2') to be visible
    47 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
