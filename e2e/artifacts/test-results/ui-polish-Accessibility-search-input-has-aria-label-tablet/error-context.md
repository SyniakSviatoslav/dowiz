...
- Name: ui-polish.spec.ts >> Accessibility >> search input has aria-label
- Location: e2e\tests\ui-polish.spec.ts:368:3
...
Call log:
  - waiting for locator('h2') to be visible
    30 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
