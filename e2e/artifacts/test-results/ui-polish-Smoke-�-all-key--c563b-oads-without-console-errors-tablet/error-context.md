...
- Name: ui-polish.spec.ts >> Smoke � all key screens load without errors >> Admin Dashboard loads without console errors
...
Call log:
  - waiting for locator('h2') to be visible
    50 × locator resolved to 3 elements. Proceeding with the first one: <h2 class="text-lg font-bold">Dowiz</h2>
