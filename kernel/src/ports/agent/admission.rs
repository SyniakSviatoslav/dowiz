...
impl AdmissionLimiter {
    ...
    pub fn new(
        ...
        let shards = (0..shard_count)
            .map(|_| TokenBucket::new(shard_capacity, shard_refill))
            .collect();
        AdmissionLimiter {
...
impl<G: AdmissionGate> Admitter<G> {
    ...
    pub fn admit<S: EventStore>(
        ...
        let record = AdmissionRecord {
            ...
            bucket: Arc::new(TokenBucket::new(granted_capacity, refill)),
        };
...
mod tests {
    ...
    fn happy_path_admits_and_records_event() {
        ...
        assert!(rec.bucket.try_acquire(4096));
        assert!(!rec.bucket.try_acquire(1), "budget envelope is real");
    }
